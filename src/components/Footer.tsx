  ...
  return (
    <footer className="py-10 relative">
      <div className="container mx-auto px-4">
        <motion.div
          className="glass-card rounded-xl py-8 px-6 text-center"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.7 }}
        >
          <h3 className="text-xl font-bold mb-4 text-gradient">Udit Narain Tewari</h3>
          ...
          <div className="text-muted-foreground text-sm">
            <p>© {currentYear} Udit Narain Tewari. All rights reserved.</p>
            <p className="mt-1">
